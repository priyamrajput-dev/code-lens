      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-3">
              <Link href="/dashboard/repos" className="text-xs text-primary hover:underline font-medium">
                View repositories →
              </Link>
            </div>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-3">
              <Link href="/dashboard/github" className="text-xs text-primary hover:underline font-medium">
                Manage App →
              </Link>
            </div>
          </CardContent>
